...
$insert = "INSERT INTO cc_tbl (fname, lname, email, password) VALUES ('$fname','$lname', '$email', '$password')";

if ($conn->query($insert) === TRUE){

	echo '<script type="text/javascript"> alert("New User Registered Successfully");
